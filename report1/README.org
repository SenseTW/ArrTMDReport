#+TITLE: 科技社群關心議題圖像 - 以資訊相關社群為例 (題目待修正)
#+AUTHOR: 陳信屹
...
** 網路社群
   ...
   這邊寫有哪幾種網路社群，須包括電商的定義、商業公司的定義、IGF 的定義、自由軟體社群的定義，還有釐清網軍跟寫手的差別。另外也要釐清公民科學。
** 文化研究
   依據 Wikipidia 的定義，「文化研究關心的是日常生活中的意義與活動。 文化活動是指某個文化中的人們如何去進行某些事情（比如說觀看電視或外出用餐），而他們之所以這樣去進行事情則與某些文化意義有關。在文化研究的脈絡下，「文本」（text）這個概念不只是在講書寫下來的文字，還包括了電影、攝影、時尚或髮型；文化研究的文本對象包含了所有有意義的文化產物。」([[https://zh.wikipedia.org/wiki/%E6%96%87%E5%8C%96%E7%A0%94%E7%A9%B6 ][Wikipidia: 文化研究]])。

   本文採用之「文本」為社群在網路中共創、有意義的文化產物，包含網路討論串、新聞、共筆、演講、軟體等等，在研究方法一章將詳加說明收錄原則。
** 利害關係人指認
** 小結
* 研究方法
** 數位生活史分析法
...
*** 統計各社群關心議題 
    1. 盤點出每個社群的主要數位討論空間 ( facebook group or telegram ) 2013 年到 2018 年的熱門新聞相關討論串。 (Engagement 的強度定義: 討論串留言數 >= 20)。 
...
* 研究範圍與限制
 ...
 3. 本文盤點之社群跟活動不可能窮盡，此乃因數位時代流動性組織可能隨時分拆、重組或創建。
** 研究者的位置
...
* 結果與討論
  ...
  #+END_COMMENT
** 本章大綱
  第一段寫 Internet 促成通訊方式改變，並且改變了人類對「社會真實」的認定方式，同時也改變了組織方式（Manuel Castells，2010），而由於成為人民團體成本過高，此類因網路而出現的社群便不傾向登記為人民團體，在這樣的狀況下這類人變成了政策規劃上的「沈默輸家」。 
  第二段寫儘管有了「公民審議」、「電子民調」，但由於主導「公民審議」、「電子民調」者缺乏數位行銷的概念與技巧，以及對社群多元性，數位認同的了解，在流程設計上使得數位原民往往仍然「不知道怎麼參與」」或是「沒有動力參與」，依舊還是「沈默輸家」。

  第三段寫因特定議題質變開始「參與」。

  第四段寫新的組織型態要怎麼推估代表性跟族群大小。
  ...
  1. 背責任的做最終決策。
  2. 分支 (fork) 的自由與附 (source) 的重要性
** 因網路產生的無組織
** 質變的開始：從冷漠到關心再到參與
  #+BEGIN_QUOTE
  nilchild: 「隔月，政府又推出了新電信法第九條，這是我覺得比智財局研議的方案侵害的程度更大。所以我又做了一個懶人包 ... 它一天之內就好幾千個分享，最後將近一萬個分享，然後我們的數據統計，在 Facebook 上28天內不重複接觸到的是八十幾萬人，那更何況九把刀寫文章，還有知名部落客在 plurk 上面的噗，也被分享了數千次，所以我們推估是台灣大概兩千三百萬人有接觸到這樣的情況。」
  .... 我們做這些事情，基本上是無償的嘛，那難道他做起來很愉快嗎？沒有啊！很痛苦啊！你看到那個成果、跟那個過程完全是無法相比的。可是有一件事情是，讓我們可以振奮無比的去做，那就是：結果的改變是有可能的。
  來源: http://nchild.blogspot.com/2014/08/blog-post.html, 取於 2018/10/11。
  #+END_QUOTE
  1. 2000 年左右 ICOS 有政策相關議題, 2006 左右分家, 2012 之後 clkao 開始弄 g0v、OSDC, COSCUP 開始出現社會議題、政策議題。
  2. 這裡寫 Web 興起使得軟體工程師能透過支援救災去參與社會議題的契機，之後透過視覺化監督政府，資料科學興起後，工程師又多了一個管道可以參與。
  3. 這裡寫政治分析脈絡下的「冷漠輸家」跟「惰性共識」的最後否決權。
** 特質
...
*** 族群大小
  ...
  // 這裡寫當母體無法得知時，要怎麼推估母體大小，百分之一的轉換率 (rex 要給我論文)
  //DSP 的 Johnson 在 R 社群分享過，當時是用生態學的做法去推估未登記社福機構的總數。 我印象中當時的情境，有很多社福機構沒有登記，但有許多網站會列出這些機構。從各種網站列出的機構名稱比對重複的機構，可以推估未登記機構總數是多少。類比於野外生物在幾個觀測點的捉放
...
*** 社群關心議題    
   ...
   | Fedora 台灣社群                      |      |        |
   | KDE Taiwan                           |      |        |
   | Taiwan Linux Kernel Hackers (TWLKH)  |      |        |
   | Open Data Taiwan                     |      |        |
   | Webduino                             |      |        |
   | Spark TW                             |      |        |
   | Emacs Taiwan                         |      |        |
   ...
   | 師大性壇 Gamily                      |      |        |
*** 焦點議題
   這裏寫社群跟政府對於社會議題裡面的價值之爭，這部分還在調整。
**** 焦點事件
   這裏寫些比較大的社會議題，影響到的族群，並列出相關法規跟政策，以及主要問題點。
   - 萬碼奔騰
   - 無名小站與 TaNet
   - Child of Internet。
   - 台北市 Android App 下架。
...
***** 開源是一種菁英主義
   「參與開源的門檻要求很高，實屬菁英主義」，每個人都應該是可以互相合作的個體，具備良好的溝通能力與工作技能，當工作上需要合作或處理問題時，能自己直接找到相對應的人，互相交流溝通並自己解決問題，而且有這種能力的人，將得到更多的資源做更多的事。
    by 李圭烽：開源是一種菁英主義，取自 https://www.ithome.com.tw/news/93608。
***** 避免知識者傲慢的反思
***** 跨性別、女性培力
***** 小結 
      這裡講多元與涵融
...
*** 網路社群利害關係人指認方法
   // 這邊要再修
     類似網路行銷的問題，如何在眾多的使用者中找到會對我的商品感興趣的消費者？換成政府的語境就是，如何找到對科技政策相關技術有研究的網路社群？這邊借用電商行銷的方法，介紹如何從議題關鍵字在網路上找到目標活躍科技社群，大致分為以下五個步驟：
...
**** 知識關鍵字發想法
     針對該領域閱讀大量資料。不只是期刊論文，平時應廣泛閱讀國內外科技論壇、電子報、部落格、網路科技媒體、意見領袖自媒體，訂閱 RSS、加入專業討論電子郵件群組、Google 快訊等，甚至參與跨國開源貢獻計劃，實際上加入技術討論。因為如今技術發展很快，在專業學術期刊上所刊出的研究，至少落後最新技術一年以上。維基百科可能不是學術等級的資料來源，但是在科技方面通常會有非常大量的外部連結資源跟參考資料，也是對於一個技術快速瞭解的方式。
     或是利用數位工具：有些數位工具能夠幫忙你以關鍵字搜關鍵字，讓你知道跟這個關鍵字相關的常搜關鍵字是什麼。 ​http://conceptnet.io/​、​http://schema.io​ 都可嘗試。
**** 從關鍵字找到關鍵活動與關鍵社群
...
* 附錄
** 社群自辦大型活動清單
   社群自辦大型活動清單, https://docs.google.com/spreadsheets/d/1cB07Cy4rsQCqb9FB4Ju_KoMc6AHOammQ28AQei8-Gn0/edit#gid=1963403972
** 活躍資訊社群清單
   活躍資訊社群清單, https://docs.google.com/spreadsheets/d/1cB07Cy4rsQCqb9FB4Ju_KoMc6AHOammQ28AQei8-Gn0/edit#gid=0
* 工作區
** 文獻回顧蒐集單
  相關文獻盤點，非正文之參考文獻。
*** 中文部分
